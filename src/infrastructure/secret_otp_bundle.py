...
# Tools expect a single object (legacy API).
secret_otp_bundle = types.SimpleNamespace(
    normalize_service_key=normalize_service_key,
    ttl_clamp=ttl_clamp,
    build_otp_curl_payload=build_otp_curl_payload,
)