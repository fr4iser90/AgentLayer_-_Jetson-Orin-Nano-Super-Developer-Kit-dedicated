...
Beispiel (Repo-Root, ``PYTHONPATH=src``)::
    ...
    python -m src.integrations.pidea.tools.scan_chat_selectors
    python -m src.integrations.pidea.tools.scan_chat_selectors path/to/selectors.json
    python -m src.integrations.pidea.tools.scan_chat_selectors --all path/to/selectors.json
