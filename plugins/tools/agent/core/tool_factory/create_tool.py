...
from plugins.tools.agent.core.tool_factory._tool_factory_common import (
...
TOOLS: list[dict[str, Any]] = [
    {
        ...
        "function": {
            ...
            "TOOL_DESCRIPTION": (
                ...
                "Inside plugins: from apps.backend.domain.plugin_system.plugin_invoke import invoke_registered_tool — "
