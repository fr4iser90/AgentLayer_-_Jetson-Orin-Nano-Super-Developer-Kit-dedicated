...
from apps.backend.integrations.pidea.domkit.models import SelectorCandidate, ValidationResult
from apps.backend.integrations.pidea.domkit.selector_finder import find_all_candidates
from apps.backend.integrations.pidea.domkit.selector_loader import load_bundle
from apps.backend.integrations.pidea.domkit.selector_validator import validate_bundle_on_page, validate_selector_on_page
...
def self_heal_run(
    ...
    *,
    ...
    """
    from apps.backend.integrations.pidea.ide_agents_admin_service import (  # noqa: PLC0415 — avoid cycle at import time
        apply_profile,
        normalize_ide,
        resolve_version,
        _run_with_page,
