...
**Note**: Tasks are automatically organized in hierarchical folder structure: `docs/agent/tasks/[category]/[name]/`
...
- **Organize files in hierarchical structure**: `docs/agent/tasks/[category]/[name]/`
...
- Create/update `docs/agent/tasks/[category]/[name]/[name]-implementation.md`
- Create/update phase files: `docs/agent/tasks/[category]/[name]/[name]-phase-[number].md`
