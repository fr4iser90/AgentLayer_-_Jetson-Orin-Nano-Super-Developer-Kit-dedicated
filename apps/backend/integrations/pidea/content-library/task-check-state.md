...
Update existing Plan/Implementation [Name]-implementation.md in docs/agent/tasks/[category]/[name]/ with current status, progress, and translation updates.
...
> - **Translation**: docs/agent/tasks/[category]/[name]/[name]-translation-[language].md
