...
from apps.backend.integrations.pidea.domkit.dom_snapshot import snapshot_accessibility, snapshot_html
from apps.backend.integrations.pidea.domkit.profile_generator import generate_from_base
from apps.backend.integrations.pidea.domkit.selector_finder import export_candidates_json, find_replacement_candidates
...
def cmd_interactive(ns: argparse.Namespace) -> int:
    from apps.backend.integrations.pidea.automation.interactive_cli import run_interactive
