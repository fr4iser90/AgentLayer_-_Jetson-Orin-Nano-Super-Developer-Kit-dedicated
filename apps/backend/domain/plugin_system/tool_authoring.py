...
def validate_registry_tool_exports(mod: Any) -> str | None:
    ...
    if isinstance(tools, dict):
        return (
            ...
            "See docker/tools/agent/agent_created/sample_echo.py or call get_tool_help(\"create_tool\")."
        )
...
tool_authoring = types.SimpleNamespace(
    sanitize_tool_filename=sanitize_tool_filename,
    slugify_registered_tool_function_name=slugify_registered_tool_function_name,
    validate_tool_source=validate_tool_source,
    validate_tool_registry_exports=validate_tool_registry_exports,
)
